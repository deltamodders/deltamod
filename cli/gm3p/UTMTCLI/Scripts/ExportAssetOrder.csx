...
string outputPath = Convert.ToString(Directory.GetParent(Convert.ToString(Directory.GetParent(System.Diagnostics.Process.GetCurrentProcess().MainModule.FileName))) + "\\output\\xDeltaCombiner\\1\\Objects\\AssetOrder.txt");
